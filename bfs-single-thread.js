...
startTracksBfsResults[0] = getTracksForIndividual(startId)
startIndividualsBfsResults[0] = new Set([startId])

// The index here is how many steps away from the target individual.
targetTracksBfsResults[0] = getTracksForIndividual(targetId)
targetIndividualsBfsResults[0] = new Set([targetId])
